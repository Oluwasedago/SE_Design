// typescript
// src/renderer/components/IDELayout/IDELayout.tsx
...
const ProjectNavigator: React.FC = () => {
  const { getCabinetsArray, getDevicesArray } = useProject();
  ...
  return (
    <div className={styles.sidebarContent}>
      <div className={styles.sidebarInner}>
        <div className={styles.sidebarTitle}>Project Navigator</div>
        <div className={styles.sidebarStats}>
          Cabinets: {cabinets.length}<br />
